...
namespace ClassLibraryTest
{
    ...
    public class FigureJudgeTest
    {
        ...
        public void GetResultTest_1()
        {
            ...
            var target = new FigureHolder(triangle, circle);
            Assert.AreEqual(Result.a_円が三角形に含まれる, FigureJudge.GetResult(target));
        }
        ...
        public void GetResultTest_2()
        {
            ...
            var target = new FigureHolder(triangle, circle);
            Assert.AreEqual(Result.c_一部共通部分がある, FigureJudge.GetResult(target));
        }
        ...
        public void GetResultTest_3()
        {
            ...
            var target = new FigureHolder(triangle, circle);
            Assert.AreEqual(Result.b_三角形が円に含まれる, FigureJudge.GetResult(target));
        }
        ...
        public void GetResultTest_4()
        {
            ...
            var target = new FigureHolder(triangle, circle);
            Assert.AreEqual(Result.d_共通部分がない, FigureJudge.GetResult(target));
        }
